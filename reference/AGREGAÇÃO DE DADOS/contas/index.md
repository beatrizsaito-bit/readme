...
<Callout icon="📘" theme="info">
  Para retornar todos os dados de contas e transações de conta é necessário que o consentimento tenha as permissões `ACCOUNTS_READ`, `ACCOUNTS_BALANCES_READ`, `ACCOUNTS_OVERDRAFT_LIMITS_READ`, `ACCOUNTS_OVERDRAFT_LIMITS_READ`
</Callout>
