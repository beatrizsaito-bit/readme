...
Inicia o fluxo de criação de um consentimento Open Finance para um usuário final (pessoa física ou jurídica). Retorna uma URL de redirecionamento para que o usuário autorize o acesso aos dados na instituição financeira selecionada.
