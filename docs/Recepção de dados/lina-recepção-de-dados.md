...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c875e13b55261dbc34512be7b475d05cce8cd37e60364480b1856edb0bb05f8c-image.png",
        null,
        ""
      ],
      "align": "right"
...
_E.x. Visualização de saldo de contas bancárias em diferentes bancos, e cálculo do saldo total consolidado._
...
_E.x. Média de consumo, categorização e inferência de renda para usuários que realizaram a aprovação de consentimento na Plataforma Lina._
...
_E.x. Notificação via webhook para alerta de possível inadimplência, sugestão de investimento baseado no perfil do usuário, etc._
