...
Após a confirmação o pagamento será realizado e retornado para a URL informada no campo "redirectUri" ("[https://redirect-demo-opal.vercel.app"](https://redirect-demo-opal.vercel.app")) do Body inicial da API. No retorno é concatenado o "paymentLinkId" que deve ser utilizado para consultar o Status do Pagamento.
